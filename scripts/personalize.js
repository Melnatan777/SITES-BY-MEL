...
// Placeholder values used in each template — must match exactly what's in the HTML files
const PLACEHOLDERS = {
  'service-pro': {
    businessName: 'ServicePro',
    phone: '(555) 123-4567',
  ...
  'table-ready': {
    ...
    phone: '(555) 123-4567',
    email: 'hello@lamesa.com',
    address: '1234 Main Street',
    tagline: 'Authentic Cuisine — Houston, TX',
    city: 'Houston',
  },
  'key-ready': {
    businessName: 'KeyReady Realty',
    phone: '(555) 123-4567',
    email: 'sarah@keyreadyrealty.com',
  ...
  'shop-front': {
    ...
    phone: '(555) 123-4567',
    email: 'hello@violetandco.com',
    address: '123 Boutique Lane, Your City, State',
    tagline: 'Curated Pieces for Every Occasion',
    city: 'Your City',
  },
  'voice-first': {
  ...
  'gather-here': {
    ...
    phone: '(555) 123-4567',
    email: 'info@cornerstonefellowship.com',
  ...
  'pet-shop': {
    businessName: 'PawPerfect Pet Spa',
    phone: '(555) 000-0000',
    email: 'info@pawperfect.com',
    address: '123 Main Street, Your City, State 00000',
    tagline: 'Professional Grooming & Loving Care',
    city: 'Your City',
  },
  'beauty-studio': {
    ...
    address: '456 Beauty Lane, Your City, State 00000',
  ...
  'lens-and-light': {
    ...
    address: '123 Studio Row, Your City, State',
    tagline: 'Every Frame Tells a Story',
    city: 'Your City',
  },
  'wellness-pro': {
    businessName: 'Serene Wellness',
    phone: '(555) 987-6543',
    email: 'info@serenewellness.com',
    address: '456 Wellness Way, Suite 12',
    tagline: 'Healing That Honors the Whole You',
    city: 'Portland',
  },
  'green-cut': {
    businessName: 'GreenCut Lawn &amp; Landscape',
    phone: '(555) 000-0000',
    email: 'john@example.com',
    address: '123 Main St, Your City, ST',
    tagline: 'Professional Lawn Care & Landscaping',
    city: 'Your City',
  },
  'sparkle-clean': {
  ...
  'bright-minds': {
    businessName: 'BrightMinds',
    phone: '(555) 020-0200',
    email: 'hello@brightminds.com',
    address: '123 Learning Lane, Suite 200',
    tagline: 'Every Student Deserves to Succeed',
    city: 'Your City',
  },
  'forever-events': {
    businessName: 'ForeverEvents',
    phone: '(555) 030-0300',
    email: 'hello@foreverevents.com',
    address: '456 Celebration Ave, Suite 100',
    tagline: 'Creating Moments That Last Forever',
    city: 'Your City',
  },
  'auto-shine': {
    businessName: 'AutoShine Detail &amp; Service',
    phone: '(555) 000-0000',
    email: 'hello@autoshinedetail.com',
    address: '123 Auto Row, Your City, State',
    tagline: 'Your Car Deserves the Best',
    city: 'Your City',
  },
  'detail-pro': {
    businessName: 'DetailPro Auto Detailing',
    phone: '(555) 000-0000',
    email: 'hello@detailpro.com',
    address: '123 Detail Lane, Your City, State',
...
const PHOTO_MAP = {
  ...
  'table-ready': {
    ...
    photoFood3:    'https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=800&q=80',
  ...
  'gather-here': {
    ...
    photoFood:   'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&q=80',
  },
  'pet-shop': {
  ...
  'green-cut': {
    ...
    photoBefore:    'https://images.unsplash.com/photo-1416965628607-37e6c8d02b59?w=800&q=80',
  ...
  'fit-life': {
    ...
    photoHIIT:      'https://images.unsplash.com/photo-1552674605-db6ffd4facb5?w=900&q=80&fit=crop',
    photoStrength:  'https://images.unsplash.com/photo-1517838277536-f5f99be501cd?w=600&q=80&fit=crop',
    photoTrainer1:  'https://images.unsplash.com/photo-1571731956672-f2b94d7dd0cb?w=600&q=80&fit=crop',
    photoTrainer2:  'https://images.unsplash.com/photo-1605296867304-46d5465a13f1?w=600&q=80&fit=crop',
    photoTrainer3:  'https://images.unsplash.com/photo-1541534741688-6078c6bfb5c5?w=600&q=80&fit=crop',
  },
  'sparkle-clean': {
  ...
  'auto-shine': {
    photoHero:      'https://images.unsplash.com/photo-1550355291-bbee04a92027?w=1600&q=80',
    photoInterior:  'https://images.unsplash.com/photo-1503736334956-4c8f8e92946d?w=800&q=80',
    photoBA1Before: 'https://images.unsplash.com/photo-1583121274602-3e2820c69888?w=800&q=80',
  ...
  'detail-pro': {
    photoHero:      'https://images.unsplash.com/photo-1449965408869-eaa3f722e40d?w=1600&q=80',
    ...
    photoBAAfter:   'https://images.unsplash.com/photo-1567808291548-fc72038bb49e?w=800&q=80',
    photoCeramic:   'https://images.unsplash.com/photo-1542362567-b07e54358753?w=800&q=80',
    photoInterior:  'https://images.unsplash.com/photo-1552519507-da3b142a6f3c?w=800&q=80',
  },
};
